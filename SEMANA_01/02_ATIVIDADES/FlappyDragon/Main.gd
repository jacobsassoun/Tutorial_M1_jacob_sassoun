...
var status = 1 # verificação para começar o jogo 
var vscore = 0 # pontuação depois de passar cada obstáculo 
var x = 3 # velocidade horizontal
var y = 3 # velocidade vertical 
